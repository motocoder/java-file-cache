...
import static com.jakewharton.disklrucache.DiskLruCache.*;
...
public final class DiskLruCacheTest {
  ...
  public static File tempDir = new File("./jake-temp");
  ...
  @Test public void openCreatesDirectoryIfNecessary() throws Exception {
    cache.close();
    File dir = new File(tempDir,"testOpenCreatesDirectoryIfNecessary");
